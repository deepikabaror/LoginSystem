...
def login():
    ...
    if user=="Parvat" and code=="1234":
        ...
        def Reset():
            entry:sandwich.delete(0,END)
            entry:cookies.delete(0,END)
            entry:Tea.delete(0,END)
            entry:cofee.delete(0,END)
            entry:juice.delete(0,END)
            entry:pancakes.delete(0,END)
            entry:pastery.delete(0,END) 
